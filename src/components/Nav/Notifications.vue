<template>
    <div id="nofications">
        <button
            class="global-notifications-icon"
        ...
        >
            ...
            <div
                v-for="(notice, index) in GET_ALL_NOTIFICATIONS"
                :key="index"
                class="notification-container"
                @click="goToAndMarkAsRead(notice)"
            >
    ...
    watch: {
        GET_ALL_NOTIFICATIONS: {
            handler: function (notices) {
                this.unreadNotices = notices.filter(
                    (notice) => !notice.read
                ).length;
            },
            immediate: true,
        ...
        markAsRead(id, index) {
            ...
            this.socket.emit("request", {
                ...
                payload: {
                    ...
                    key: "read",
                    value: true,
                    storeAction: "NOTIFICATION_MARKED_AS_READ",
